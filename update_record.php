	...
	<form method="POST">
		<div class="form-group">
		  ...
		  ?>
		  	...
		  	<input type="text" class="form-control" name="e_position"  
		  <?php
  			if (isset($_GET['ID'])){
  				echo(" value = \"".$rowSelect['emp_Position']."\" ");
  			}
		  ?>
		  	onkeypress="return alpnmrc(event,alpha);"/>

		<label class="emp_form">Status:</label>
        <select class="form-control" name="e_status">
          <option value="Active"  
		  <?php
  			if (isset($_GET['ID'])){
  				echo(" value = \"".$rowSelect['emp_Status']."\" ");
  			}
		  ?>
          > Active</option>
