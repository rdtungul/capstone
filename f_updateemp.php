...
function editEmp(){
	...
	$sql = "UPDATE emp_reg SET emp_Lname = '$emp_Lname', emp_Fname = '$emp_Fname', emp_Mname = '$emp_Mname', emp_Position = '$emp_Position', emp_Status = '$emp_Status' WHERE emp_ID = '$emp_ID';";
    mysql_query($sql);
	}
	$result = mysql_query($sql);
	if(!$result)
